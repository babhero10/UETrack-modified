...
@register_model
def fastitpns(pretrained=False, pos_type="interpolate", pretrain_type="", patchembed_init="copy", distill_layer=[], **kwargs):
    model = Fast_iTPN(
...
@register_model
def fastitpnb(pretrained=False, pos_type="interpolate", pretrain_type="", patchembed_init="copy", distill_layer=[], **kwargs):
    model = Fast_iTPN(

...
cfg.MODEL.TASK_INDEX.OTB99_LANG = 1
...
cfg.TRAIN.TEACHER_TYPE = 'fastitpns'
cfg.TRAIN.DISTILL_LAYER_T = []
cfg.TRAIN.DISTILL_LAYER_S = []
cfg.TRAIN.KD_WEIGHT = 5.0
cfg.TRAIN.FEAT_WEIGHT = 0.2
cfg.TRAIN.FEAT_HEAD_WEIGHT = 1.0
cfg.TRAIN.TEACHER_PATH = ""
# DATA
cfg.DATA = edict()
...
cfg.DATA.USE_NLP.OTB99_LANG = False
